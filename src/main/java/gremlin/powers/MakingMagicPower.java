...
public class MakingMagicPower extends AbstractGremlinPower {
    public static final String POWER_ID = getID("MakingMagic");
    private static final PowerStrings strings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    private static final Texture IMG = new Texture(GremlinMod.getResourcePath("powers/making_magic.png"));

    public MakingMagicPower(AbstractCreature owner, int amount) {
