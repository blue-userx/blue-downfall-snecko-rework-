...
public class DiscoverEtherealAction extends AbstractGameAction {
    ...
    private ArrayList<AbstractCard> generateCardChoices() {
        ...
        while (derp.size() != 3) {
            ...
            possList.removeIf(c -> (c.color != AbstractDungeon.player.getCardColor() || !c.isEthereal || c.color == AbstractCard.CardColor.CURSE || c.type == CURSE || c.rarity == AbstractCard.CardRarity.SPECIAL || c.rarity == AbstractCard.CardRarity.BASIC ||c.type == STATUS || c.hasTag(AbstractCard.CardTags.HEALING)));
