...
public abstract class AbstractTimeCard extends CustomCard {
    ...
    public AbstractTimeCard(final String id, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        super(id, "ERROR", getCorrectPlaceholderImage(type, id),
                cost, "ERROR", type, TimeEaterChar.Enums.TIME_EATER_PURPLE, rarity, target);
    ...
    public AbstractTimeCard(final String id, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        super(id, "ERROR", getCorrectPlaceholderImage(type, id),
