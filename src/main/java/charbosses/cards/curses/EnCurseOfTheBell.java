...
public class EnCurseOfTheBell extends AbstractBossCard {
    ...
    public EnCurseOfTheBell() {
        super(ID, EnCurseOfTheBell.cardStrings.NAME, "curse/curse_of_the_bell", -2, EnCurseOfTheBell.cardStrings.DESCRIPTION, CardType.CURSE, CardColor.CURSE, CardRarity.SPECIAL, CardTarget.NONE, AbstractMonster.Intent.NONE);
