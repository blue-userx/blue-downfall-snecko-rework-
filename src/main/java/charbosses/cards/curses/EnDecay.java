...
public class EnDecay extends AbstractBossCard {
    ...
    public EnDecay() {
        super(ID, EnDecay.cardStrings.NAME, "curse/decay", -2, EnDecay.cardStrings.DESCRIPTION, CardType.CURSE, CardColor.CURSE, CardRarity.CURSE, CardTarget.NONE, AbstractMonster.Intent.NONE);
    }
