...
public class DonuDecaChar extends CustomPlayer {

    static final String ID = makeID("donudeca");
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public DonuDecaChar(String name, PlayerClass setClass) {
    ...
    public AbstractCard.CardColor getCardColor() {
        return Enums.CONSTRUCTS_GORANGE;
    }
    ...
    public AbstractPlayer newInstance() {
        return new DonuDecaChar(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_CONSTRUCTS;
        @SpireEnum(name = "CONSTRUCTS_GORANGE")
        public static AbstractCard.CardColor CONSTRUCTS_GORANGE;
        @SpireEnum(name = "CONSTRUCTS_GORANGE")
