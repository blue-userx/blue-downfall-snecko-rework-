...
public class DonuDecaMod implements
    ...
    //Todo: Is gorange possible like can you actually split the color halfway and make half green and the other half orange
    ...
    public DonuDecaMod() {
        ...
        BaseMod.addColor(DonuDecaChar.Enums.CONSTRUCTS_GORANGE, characterColor, characterColor, characterColor,
    ...
    public static void initialize() {
        DonuDecaMod thismod = new DonuDecaMod();
    }

    @Override
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new DonuDecaChar(DonuDecaChar.characterStrings.NAMES[1], DonuDecaChar.Enums.THE_CONSTRUCTS),
            CHARSELECT_BUTTON, CHARSELECT_PORTRAIT, DonuDecaChar.Enums.THE_CONSTRUCTS);
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd(modID)
                .packageFilter(AbstractDonuDecaCard.class)
                .setDefaultSeen(true)
                .cards();
    }
