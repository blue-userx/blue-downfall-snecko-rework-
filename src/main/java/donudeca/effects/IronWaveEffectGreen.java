...
public class IronWaveEffectGreen extends AbstractGameEffect {
    ...
    public IronWaveEffectGreen(float x, float y, float cX) {
    ...
    public void update() {
        ...
        if (this.waveTimer < 0.0F) {
            ...
            AbstractDungeon.effectsQueue.add(new IronWaveParticleGreen(this.x, this.y));
            if (this.x > this.cX) {
                this.isDone = true;
