...
public class BabySneckoAttackAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        AbstractDungeon.actionManager.addToBottom(new PseudoDamageRandomEnemyAction(m, new DamageInfo(AbstractDungeon.player, 9, DamageInfo.DamageType.THORNS), AttackEffect.BLUNT_LIGHT));
